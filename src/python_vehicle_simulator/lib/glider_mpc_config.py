...
class MPCConfig:
    ...
    def __init__(self):
        ...
        self.R = np.diag([
            ...
            10.0,       # gamma_dot - 电池旋转速度惩罚
            1.0         # m_b_dot - 浮力调节速度惩罚（油泵相对快）
        ])
    ...
    def print_config(self):
        ...
        print(f"Prediction horizon: N = {self.N}, Ts = {self.Ts}s, T = {self.T_horizon}s")
        print(f"State dimension: {self.n_states}")
        print(f"Control dimension: {self.n_controls}")
        ...
        print("Reference values (DIVE mode):")
...
if __name__ == "__main__":
    ...
    print("\nDIVE reference vector:")
    print(config.get_dive_reference())
    
    print("\nCLIMB reference vector:")
    print(config.get_climb_reference())
